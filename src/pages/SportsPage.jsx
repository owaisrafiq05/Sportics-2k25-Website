...
const sportsData = [
  ...
  { name: 'Badminton Singles Boys', fee: 1500, category: 'Sports' },
  { name: 'Badminton Singles Girls', fee: 1500, category: 'Sports' },
  { name: 'Badminton Doubles Boys', fee: 2500, category: 'Sports' },
  { name: 'Badminton Doubles Girls', fee: 2500, category: 'Sports' },
  { name: 'Table Tennis Singles Boys', fee: 1200, category: 'Sports' },
  { name: 'Table Tennis Singles Girls', fee: 1200, category: 'Sports' },
          ...
          <div className="sports-list">
            {sportsData.filter(sport => sport.category === category).map((sport, index) => (
              <div key={index} className="sport-item">
                ...
                <div className="sport-fee">Fee: {sport.fee} PKR</div>
              </div>
            ))}
          </div>
        </div>
