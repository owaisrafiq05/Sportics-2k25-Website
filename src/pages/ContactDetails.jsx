      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-6 md:gap-12 md:flex-row md:flex-wrap justify-center">
          {contactData.map((contact, index) => (
            <div key={index} className="w-full sm:w-[300px] md:w-[400px] bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105">
              <div className="p-6">
